...
Based on the simple linear model of our preliminary variables, the Adjusted R<sup>2</sup> is 0.8799, which means approximately 88% of the variability in price can be explained by eight variables for the 1000 observed houses in the training data set.  Furthermore, looking at p-values, five numerical variables are significant at α = 0.001, and the sixth is very close.
...
The model has an Adjusted R<sup>2</sup> of 0.9293.  93% of the variance of price is explained by eight of the 81 variables. Furthermore, each of the eight predictors, whether it be numerical or at least one level in a categorical, is significant at the α = 0.001 level.
